...
{ 
    public class LoadJsonToAesCommand:ILoader
    {
        public T Execute<T>(string path, SystemData systemData) where T : ISaveableEntity
        {
            byte[] encryptedData = File.ReadAllBytes(path);
            string dataAsJson = DecryptStringFromBytesAes(encryptedData, systemData.Password);
